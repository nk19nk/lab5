...
public class Main {
    ...
    //4.2
    public static Map<String, List<Integer>> reader(String file){
    ...
    public static void maxfind(Map<String, List<Integer>> people) {
        int maximum = 0;
    ...
    public static void main(String[] args) {
        ...
        Polyline polyline = points.stream().distinct().map(point -> new Point(point.getX(), Math.abs(point.getY())))
                .sorted(Comparator.comparingDouble(point -> point.getX()))
                .collect(Collectors.collectingAndThen(Collectors.toList(), pointList -> new Polyline(pointList)));
